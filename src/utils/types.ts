import type { BlockObjectResponse, BulletedListItemBlockObjectResponse, NumberedListItemBlockObjectResponse, PageObjectResponse, ToggleBlockObjectResponse } from '@notionhq/client/build/src/api-endpoints.d.ts'
